...
from pyqt_qtcpsocket_serveur_ajax_terminal_analyse_SD_timerRTC import * # fichier obtenu à partir QtDesigner et pyuic4
...
"""
	...
	def timerEvent(self,indexIn):
		...
		data=str(timerRTCList[indexIn].compt)+";"+str(int(time.time()))+"\n" # int time.time car renvoie float... 		
